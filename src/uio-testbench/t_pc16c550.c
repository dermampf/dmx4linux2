...
int main (int argc, char **argv)
{
  ...
  struct rtuart_bus * bus = uio32_create(fd, /*offset:*/0x1000, /*size:*/0x10000 /*0x4096*/);
  if (!bus)
    return 1;
  struct rtuart * uart = pc16c550_create(100000000); // 100MHz
  if (!uart)
    return 1;
  uart->bus = bus;
